create table if not exists public.eventos (
  ...
  pagamento_avista boolean not null default false,
  pagamento_parcelado boolean not null default false,
  data_sinal date,
...
alter table public.eventos
  ...
  add column if not exists pagamento_avista boolean not null default false,
  add column if not exists pagamento_parcelado boolean not null default false,
